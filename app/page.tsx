    ...
    <main className={styles.main}>
      ...
      <div className={styles.contentWrapper}>
        <section className={styles.section} id='read'>
          <div className={styles.center}>
            <p>
              ...
              <span style={{ color: 'aqua', fontWeight: 700 }}>Emil Ahmad</span>{' '}
            ...
            <div style={{ textAlign: 'left', marginBottom: '2rem' }}>
              ...
              <SlideInLeft>
                <p className={styles.p}>
                  ...to my internship presentation at DeGaming Group. Here, you
                  can explore my work with advanced web technologies like:{' '}
                  <br />
                  <br />
                  Next.js,
                  <br />
              ...
              <SlideInLeft>
                <p className={styles.p}>
                  ...
                  clear overview of their investments and current status. <br />
                  <br />
                  Currency Exchange and Network Switching: An essential part of
                  the platform was enabling easy currency exchange between
                  ...
                  into platform activity and performance, I included features to
                  display statistics such as Total Value Locked (TVL), trading
                  volume, and other relevant data. <br />
              ...
              <SlideInLeft>
                <p className={styles.p}>
                  ...
                  Through daily interactions with colleagues and mentors, I have
                  grown as an individual contributor and as part of a larger
                  organization.
                  <br />
                  ...
                  blockchain technology within iGaming but has also strengthened
                  my conviction that I have chosen the right career.
              ...
              <SlideInLeft>
                <p className={styles.p}>
                  ...
                  Comparing theoretical education with practical experience from
                  the LIA shows that the entire IT industry is constantly
                  evolving. <br />
                  There are many ways to solve problems and work as a developer,
                  both individually and in teams, depending on personal
                  preferences, customer orders, and specific requests.
                  <br /> It is essential to be flexible and open to suggestions
                  and changes, as each workplace has its methods, tools, and
        ...
        <section className={styles.section} id='presentation'>
          <AnimatedText text='Presentation threejs' className={styles.title4} />
          <Presentation3d />
        </section>
        <section className={styles.section}>
          ...
          <SlideInLeft>
            <p style={{ textAlign: 'left', marginBottom: '2rem' }}>
              ...
              <br />
              once again thank you DeGaming Group for the time and giving me the
              change to work with such an awesome team
              <br />
            </p>
          </SlideInLeft>
        </section>
